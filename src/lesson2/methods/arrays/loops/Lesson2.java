package lesson2.methods.arrays.loops;
...
// 1) Разобрать "while" и "do while"
        ...
        System.out.println("'while' test: " + whileTest);
        /*
        ...
        */
        ...
        System.out.println("'do - while' test: " + whileTest);
        /*
...
// 3) Метод расчитывающий факториал
        ...
        System.out.println("factorial of 10L " + factorial(10L));
        factorial(11.2);
        /*
...
// 4)применить бинайрный поиск в отсортированном массиве
        ...
        if (foundedIndex >= 0) System.out.println("The " + wantedVal +
                " found at " + foundedIndex + " index!");
        else System.out.println("The " + wantedVal +
                " is not found!");
...
//      (такой элемент в массиве только один)
        ...
        System.out.println((withoutPairVal==0)?
